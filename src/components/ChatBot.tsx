  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 bg-[#003366] text-white p-4 rounded-full shadow-lg hover:bg-blue-800 transition-colors z-50 ${
          isOpen ? 'hidden' : 'flex'
        }`}
      >
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 w-96 bg-white rounded-xl shadow-xl z-50">
          {/* Header */}
